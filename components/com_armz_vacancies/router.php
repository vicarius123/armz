...
JLoader::registerPrefix('Armz_vacancies', JPATH_SITE . '/components/com_armz_vacancies/');

/**
 * Class Armz_vacanciesRouter
 *
 * @since  3.3
 */
class Armz_vacanciesRouter extends JComponentRouterBase
{
	/**
	...
	public function build(&$query)
	{
		...
		if (isset($query['id']))
		{
			if ($view !== null)
			{
				$model      = Armz_vacanciesHelpersArmz_vacancies::getModel($view);
				if($model !== null)
				{
