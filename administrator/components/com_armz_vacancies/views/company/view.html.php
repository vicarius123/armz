 ...
 * @since  1.6
 */
class Armz_vacanciesViewCompany extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ARMZ_VACANCIES_TITLE_COMPANY'), 'company.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_armz_vacancies.company', $this->item->id);
		}
