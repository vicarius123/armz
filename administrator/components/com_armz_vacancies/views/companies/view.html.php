 ...
 * @since  1.6
 */
class Armz_vacanciesViewCompanies extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Armz_vacanciesHelper::addSubmenu('companies');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ARMZ_VACANCIES_TITLE_COMPANIES'), 'companies.png');
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('companies.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		JHtmlSidebar::setAction('index.php?option=com_armz_vacancies&view=companies');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_ARMZ_VACANCIES_COMPANIES_NAME'),
		);
	}
