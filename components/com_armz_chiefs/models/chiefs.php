...
/**
 * Methods supporting a list of Armz_chiefs records.
 *
 * @since  1.6
 */
class Armz_chiefsModelChiefs extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_ARMZ_CHIEFS_SEARCH_FILTER_DATE_FORMAT"), "warning");
